...
const ProductList = () => {
  ...
  return (
    <div className='container' style={{display: "block", background: "none"}}>
      ...
      <Link to="/addProduct" className="btn btn-outline-primary">Add User</Link>
      </div>
      <table className="table">
        ...
        {users.map((user, index) => (
          <tr>
            ...
            <td>
              <Link className='btn btn-outline-primary m-1' to={`/user/${user.id}`}><i class="fa fa-eye" aria-hidden="true"></i></Link>
              <Link className='btn btn-primary m-1' to={`/editProduct/${user.id}`}><i class="fa fa-pencil" aria-hidden="true"></i></Link>
